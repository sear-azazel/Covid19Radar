...
[assembly: Xamarin.Forms.ExportRenderer(typeof(Xamarin.Forms.MasterDetailPage),
	typeof(Xamarin.Forms.Platform.iOS.Covid19PhoneMasterDetailRenderer), UIUserInterfaceIdiom.Phone)]
namespace Xamarin.Forms.Platform.iOS
{
	public class Covid19PhoneMasterDetailRenderer : UIViewController, IVisualElementRenderer, IEffectControlProvider
	{
		...
		public Covid19PhoneMasterDetailRenderer()
		{
		}
		...
		public void SetElement(VisualElement element)
		{
			...
			if (element != null)
			{
				System.Reflection.MethodInfo SendViewInitialized = element.GetType().GetMethod("SendViewInitialized",
					System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
				SendViewInitialized?.Invoke(element, new object[] { NativeView });
			}
		}
		...
		void LayoutChildren(bool animated)
		{
			...
			var masterRenderer = Platform.GetRenderer(MasterDetailPage.Master);
			if (masterRenderer == null)
				return;
			var masterView = masterRenderer.ViewController.View;
			...
			var target = frame;
			target.Width = masterFrame.Width;
            if (Presented)
            {
            ...
            if (animated)
			{
				...
				view.Frame = target;
				masterView.Layer.Opacity = (float)opacity;
				UIView.SetAnimationCurve(UIViewAnimationCurve.EaseInOut);
				UIView.SetAnimationDuration(1250);
		...
		{
			System.Reflection.MethodInfo ApplyNativeImageAsync = this.GetType().BaseType.GetMethod("ApplyNativeImageAsync",
				System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);
			ApplyNativeImageAsync?.Invoke(this, new object[]{ Page.BackgroundImageSourceProperty, new Action<UIImage> (bgImage =>
			{
				if (bgImage != null)
		...
		void UpdateMasterDetailContainers()
		{
			...
			var RespondsToSetNeedsUpdateOfHomeIndicatorAutoHidden = typeof(Forms).GetProperty("RespondsToSetNeedsUpdateOfHomeIndicatorAutoHidden",
				System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);

			if ((bool)RespondsToSetNeedsUpdateOfHomeIndicatorAutoHidden?.GetValue(null, null))
		...
		void UpdateLeftBarButton()
		{
			...
			if (firstPage != null)
			{
				var SetMasterLeftBarButton = typeof(NavigationRenderer).GetMethod("SetMasterLeftBarButton",
					System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
				SetMasterLeftBarButton.Invoke(null, new object[] { firstPage, masterDetailPage });
			}
		}
